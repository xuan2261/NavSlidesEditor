...
```css
.slide-menu-button, .customcontrols, .reveal .controls { opacity: 0.15 !important; transition: opacity 0.3s ease !important; }
.slide-menu-button:hover, .customcontrols:hover, .reveal .controls:hover { opacity: 1 !important; }
```
