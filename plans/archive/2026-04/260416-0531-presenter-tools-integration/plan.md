...
1. **Inject CSS variables** cho light theme override:
   ...
   [data-theme='light'] .reveal .slides section {
     color: #1a1a2e;
   }
   [data-theme='light'] .reveal .slide-background {
...
2. **Inject floating button** (góc trên phải):
   ...
   ```html
   <div
     class="presenter-toolbar"
     style="position:fixed;top:10px;right:10px;z-index:100;display:flex;gap:5px;"
   >
