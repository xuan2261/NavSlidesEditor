...
```json
{
  "elements": [
    ...
    },
    {
      ...
      "width": 640,
      "height": 60,
      "content": "<p style=\"text-align:center; color:{TEXT}80\">Giảng viên: ... · Lớp: ... · Ngày: ...</p>"
    },
    {
      "type": "shape",
      "shape": "rect",
...
```json
{
  "elements": [
    ...
    },
    {
      ...
      "width": 880,
      "height": 50,
      "content": "<h2 style=\"color:{PRIMARY}\">Section Title</h2>"
    },
    {
      "type": "shape",
      "shape": "rect",
    ...
    },
    {
      ...
      "width": 420,
      "height": 400,
      "content": "<p style=\"color:{TEXT}\">Left column</p>"
    },
    {
      "type": "text",
      "x": 500,
      ...
      "width": 420,
      "height": 400,
      "content": "<p style=\"color:{TEXT}\">Right column</p>"
    }
  ],
  "background": { "type": "color", "color": "{BG}" }
}
  ...
  "elements": [
    {
      ...
      "width": 800,
      "height": 100,
      "content": "<h1 style=\"text-align:center; color:{PRIMARY}\">Tóm tắt</h1>"
    },
    {
      "type": "text",
      "x": 120,
      ...
      "width": 720,
      "height": 280,
      "content": "<ul style=\"color:{TEXT}; font-size:22px\"><li>Point 1</li><li>Point 2</li><li>Point 3</li></ul>"
    }
  ],
...
function createSlide({ title, content, bg, elements, notes }) {
  return {
    ...
    elements: elements || [titleElement(title), contentElement(content)],
