...
export const ELEMENT_DEFAULTS = {
  text: {
    width: 600, height: 180, zIndex: 1,
    content: '<p>New text</p>',
  },
  image: {
    width: 400, height: 300, zIndex: 2,
    src: '', objectFit: 'contain', alt: '',
  },
  shape: {
    width: 200, height: 150, zIndex: 1,
    shape: 'rect', fill: '#6366f1', stroke: 'none',
    strokeWidth: 0, borderRadius: 0, opacity: 1,
    text: '', fontSize: 16, textColor: '#ffffff',
  },
  code: {
    width: 600, height: 320, zIndex: 2,
    content: '// Write your code here\nfunction hello() {\n  return "Hello, World!"\n}',
    language: 'javascript', fontSize: 14,
  },
  latex: {
...
<\/script>`,
  ...
  video: {
    width: 480, height: 270, zIndex: 2,
    src: '', controls: true, autoplay: false,
    loop: false, muted: false, objectFit: 'contain', poster: '',
  },
  audio: {
    width: 400, height: 60, zIndex: 2,
    src: '', controls: true, autoplay: false, loop: false, muted: false,
  },
  table: {
    width: 600, height: 300, zIndex: 2,
    data: [['Header 1', 'Header 2', 'Header 3'], ['', '', ''], ['', '', '']],
    headerRow: true, cellPadding: 8,
    borderColor: 'rgba(255,255,255,0.2)', borderWidth: 1,
    headerBgColor: 'rgba(99,102,241,0.3)', cellBgColor: 'transparent',
  ...
  callout: {
    width: 36, height: 36, zIndex: 10,
    calloutNumber: 1, calloutColor: '#ef4444',
    calloutTextColor: '#ffffff', fontSize: 16,
  },
  qrcode: {
    width: 200, height: 200, zIndex: 2,
    qrData: 'https://example.com', qrColor: '#000000',
    qrBgColor: '#ffffff', qrErrorLevel: 'M',
  },
  drawing: {
    width: 960, height: 540, zIndex: 1,
    paths: [], strokeColor: '#ffffff', strokeWidth: 3,
  },
  line: {
    ...
    arrowStart: 'none', arrowEnd: 'arrow', dashArray: '',
  },
  svg: {
    width: 200, height: 200, zIndex: 1,
    content: '<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><circle cx="50" cy="50" r="40" fill="#6366f1"/></svg>',
