...
function instrSlide(id, bg, primary, text, instructions) {
  ...
  return mkSlide(id, bg, [
    ...
    },
    {
      ...
      height: 50,
      zIndex: 1,
      content: `<h2 style="color:${primary}">Hướng dẫn sử dụng</h2>`,
    },
    {
      type: 'shape',
      shape: 'rect',
    ...
    },
    {
      ...
      height: 400,
      zIndex: 3,
      content: `<ol style="color:${text}; font-size:20px; line-height:2">${li}</ol>`,
    },
  ])
}
...
function qnaSlide(id, bg, primary, text) {
  return mkSlide(id, bg, [
    ...
    },
    {
      ...
      height: 60,
      zIndex: 1,
      content: `<p style="text-align:center; color:${text}80; font-size:20px">Cảm ơn đã theo dõi!</p>`,
    },
  ])
}
...
function tmplObj(id, category, title, desc, tags, colorScheme, slides) {
  return {
    ...
    thumbnail: {
      type: 'gradient',
      gradient: `linear-gradient(135deg, ${colorScheme.background}, ${colorScheme.primary}30)`,
    },
    colorScheme,
    theme: 'black',
    transition: 'slide',
  ...
  tmplObj(
    ...
    [
      titleSlide(
        ...
        'Mô phỏng tương tác các cổng logic cơ bản'
      ),
      theorySlide(
        'sim1-s2',
        '#0a1628',
  ...
  tmplObj(
    ...
    [
      titleSlide(
        ...
        'Mô phỏng đáp ứng tần số mạch RLC nối tiếp'
      ),
      theorySlide(
        'sim2-s2',
        '#0d1b0e',
  ...
  tmplObj(
    ...
    [
      titleSlide(
        ...
        'Mô phỏng chỉnh định bộ điều khiển PID'
      ),
      theorySlide(
        'sim3-s2',
        '#1a0a0e',
  ...
  tmplObj(
    ...
    [
      titleSlide(
        ...
        '#d0fff5',
        '📈 Bode Plot Generator',
        'Công cụ vẽ biểu đồ Bode tương tác'
      ),
      theorySlide(
        'sim4-s2',
        '#0a1a18',
  ...
  tmplObj(
    ...
    [
      titleSlide(
        ...
        '#48bfe3',
        '#d0eeff',
        '⚡ 3-Phase Power Visualizer',
        'Animation hệ thống điện 3 pha'
      ),
      theorySlide(
        'sim5-s2',
        '#0a1628',
  ...
  tmplObj(
    ...
    [
      titleSlide(
        ...
        '#95adb6',
        '#dce5e8',
        '⚙️ Gear Train Simulator',
        'Mô phỏng truyền động bánh răng'
      ),
      theorySlide(
        'sim6-s2',
        '#0f1419',
        '#95adb6',
        '#dce5e8',
        'Truyền động bánh răng — Lý thuyết',
