...
test.describe('AI Integrations', () => {
  ...
  test('can use AI Copywriter with mocked API response', async ({ page }) => {
    ...
    await page.locator('button.btn-primary', { hasText: 'Generate' }).click();

    await expect(page.locator('div', { hasText: 'MOCKED_AI_GENERATED_CONTENT' }).last()).toBeVisible({ timeout: 5000 });
