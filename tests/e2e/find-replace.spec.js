  ...
  test.beforeEach(async ({ page, request }) => {
    ...
    await apiUpdatePresentation(request, presId, {
      slides: [{
        id: 'slide-1',
        elements: [
          { id: 'el-1', type: 'text', x: 80, y: 100, width: 400, height: 100, zIndex: 1, content: '<p>Hello World</p>' },
          { id: 'el-2', type: 'text', x: 80, y: 250, width: 400, height: 100, zIndex: 2, content: '<p>Hello Universe</p>' },
        ],
        notes: '',
